    ...
    return GameState(
        ...
        seiso=[
            SeisoTile(
                ...
                anomalia=None if t.get("anomalia") is None else _str(t, "anomalia"), is_anomalia=_bool(t, "is_anomalia"),
                limpo=_bool(t, "limpo"), anomalia_etiquetada=_bool(t, "anomalia_etiquetada"),
            )
